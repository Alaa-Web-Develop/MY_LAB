                    ...
                    <tbody>
                        ...
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <form id="myform" action="{{route('dashboard.labUsers.destroy',$user->id)}}" method="post">
                                        @csrf
                                        @method('delete')
    ...
    <div class="modal fade" id="UserAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="{{route('dashboard.labUsers.store') }}" method="post">
                    @csrf
